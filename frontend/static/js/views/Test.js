...
export default class extends AbstractView {
    ...
    <div class="maintext">
        ...
        <object class="pdfsh" data="/static/xlent_test.pdf" type="application/pdf" width="100%" height="700px" data-link>
        <p style="font-size: 4px; color: grey;">Your web browser doesn't have a PDF plugin.
